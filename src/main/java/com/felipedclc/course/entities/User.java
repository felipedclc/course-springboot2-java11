...
public class User implements Serializable {
	...
	@OneToMany(mappedBy = "client") // ATRIBUTO MAPEADO PELO CLIENT
	private List<Order> orders = new ArrayList<>(); // INSTANCIANDO A COLEÇÃO DE ORDERS
	...
	public List<Order> getOrders() { // PARA COLEÇÕES USAR SOMENTE O GET
		return orders;
	}
